...
materials_data.diffuse_color = [1, 1, 1, 1]
materials_data.use_nodes = True
materials_data.node_tree.nodes["Principled BSDF"].inputs[19].default_value[0] = 1
materials_data.node_tree.nodes["Principled BSDF"].inputs[19].default_value[1] = 1
materials_data.node_tree.nodes["Principled BSDF"].inputs[19].default_value[2] = 1
