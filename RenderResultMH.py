...
for dir in os.listdir(result_path):
    ...
    bpy.data.curves["hair"].bevel_depth = 0.008
    ...
    bpy.data.objects["sun_light"].rotation_euler[0] = 1.2211
    camera_location = np.array([0, -100, 155])
    light_location = np.array([0, -100, 200])
    ...
    bpy.data.objects["sun_light"].rotation_euler[0] = 50 / 180 * math.pi
    camera_location = np.array([0, -100, 210])
    light_location = np.array([0, -100, 250])
